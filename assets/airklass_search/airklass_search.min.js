              ...
              if (d.length >= set.minimumLength) {
                  ...
                  if (c != 0) {
                      ...
                      if (c > set.show) {
                          ...
                          if (start > 0) {
                              out += '<li role="navigation"><div class="page-outline"><div style="text-align: center;"><a class="search-result-paginator" accesskey="b" id="' + (start - set.show) + '_' + replace + '">' + airklasssearch_string_6 + '</a></div></div></li>';
                          }
                          if (page <= 2) {
                              var p_b = pages;
                              if (pages > 3) {
                          ...
                          if (page + 1 != pages) {
                              out += '<li class="paginator-page-outline" role="navigation"><div class="page-outline"><a class="search-result-paginator" accesskey="m" id="' + (start + set.show) + '_' + replace + '">' + airklasssearch_string_7 + '</a></div></li>';
                          }
                          out += '</ul></div></nav>';
                      }
