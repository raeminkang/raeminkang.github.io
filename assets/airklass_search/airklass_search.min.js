                      ...
                      if (c > set.show) {
                          ...
                          if (start > 0 && page_set != 0) {
                            ...
                            if (previous_post_num < 0) {
                              ...
                              out += '<li class="paginator-page-outline" role="navigation"><div class="page-outline"><div class="paginator-page-inline"><a class="search-result-paginator" style="cursor:pointer;" accesskey="b" id="' + previous_post_num + '_' + replace + '">' + '<img class="pagination-icon" src="/assets/images/resource/ic-backword-arrow.svg" alt="">' + '</a></div></div></li>';
                          }
                          if (page <= 4) {
                              var p_b = pages;
                              if (pages > 5) {
                              ...
                              for (var f = 0; f < p_b; f++) {
                                  if (f == page) {
                                      out += '<li class="current-paginator-page-outline" role="navigation"><div class="page-outline current-page"><div class="paginator-page-inline"><span>' + (f + 1) + '</span></div></div></li>';
                                  } else {
                                      out += '<li class="paginator-page-outline" role="navigation"><div class="page-outline"><div class="paginator-page-inline"><a class="search-result-paginator" style="cursor:pointer;" id="' + (f * set.show) + '_' + replace + '">' + (f + 1) + '</a></div></div></li>';
                                  }
                              }
                          } else {
                              var p_b = page + 4;
                          ...
                          if (page + 1 != pages && pages != page_end) {
                            ...
                            if (next_post_num > c) {
                              ...
                              out += '<li class="paginator-page-outline" role="navigation"><div class="page-outline"><div class="paginator-page-inline"><a class="search-result-paginator" accesskey="m" style="cursor:pointer;" id="' + next_post_num + '_' + replace + '">' + '<img class="pagination-icon" src="/assets/images/resource/ic-foreword-arrow.svg" alt="">' + '</a></div></div></li>';
                          }
                          out += '</ul></div></nav>';
                      }
