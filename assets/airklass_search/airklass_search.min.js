                      ...
                      if (c > set.show) {
                          ...
                          if (start > 0 && page_set != 0) {
                            ...
                            if (previous_post_num < 0) {
                              ...
                              out += '<li role="navigation"><div class="page-outline"><div style="text-align: center;"><a class="search-result-paginator" accesskey="b" id="' + previous_post_num + '_' + replace + '">' + airklasssearch_string_6 + '</a></div></div></li>';
                          }
                          if (page <= 4) {
                              var p_b = pages;
                              if (pages > 5) {
                              ...
                              for (var f = 0; f < p_b; f++) {
                                  if (f == page) {
                                      ...
                                      out += '<li class="paginator-page-outline" role="navigation"><div class="page-outline"><div style="text-align: center;"><a class="search-result-paginator" id="' + (f * set.show) + '_' + replace + '">' + (f + 1) + '</a></div></div></li>';
                                  }
                              }
                          } else {
                              var p_b = page + 4;
                          ...
                          if (page + 1 != pages && pages != page_end) {
                            ...
                            if (next_post_num > c) {
                              ...
                              out += '<li class="paginator-page-outline" role="navigation"><div class="page-outline"><a class="search-result-paginator" accesskey="m" id="' + next_post_num + '_' + replace + '">' + airklasssearch_string_7 + '</a></div></li>';
                          }
                          out += '</ul></div></nav>';
                      }
