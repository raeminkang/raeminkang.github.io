! function a(b, c, d) {
  ...
  3: [function(a, b, c) {
    ...
    function n(a, b, c, d) {
      for (var e in a)
        if (!o(a[e], d.exclude) && c.matches(a[e], b)) return a
    }
    ...
    var p = a("./SearchStrategies/FuzzySearchStrategy"),
      q = a("./SearchStrategies/LiteralSearchStrategy"),
      r = [],
      s = {};
    ...
    ! function(b, c, d) {
      ...
      b.SimpleJekyllSearch = function(a) {
        ...
        b.length > 0 && k("You must specify the following required options: " + m), l = r.merge(l, a), n.setOptions({
          ...
          fuzzy: l.fuzzy,
          limit: l.limit
        }), r.isJSON(l.json) ? e(l.json) : f(l.json)
  ...
  a.DLMenu = function(b, c) {
    ...
    _initEvents: function() {
      ...
      this.$trigger.on("click.dlmenu", function() {
        ...
        var d = a(this),
          e = d.parents("ul.dl-submenu:first"),
          f = e.parent(),
...
function(a) {
  ...
  function e(a, d, e, f) {
    var g = b.innerWidth ? b.innerWidth : c.documentElement.clientWidth ? c.documentElement.clientWidth : screen.width,
      h = b.innerHeight ? b.innerHeight : c.documentElement.clientHeight ? c.documentElement.clientHeight : screen.height,
      i = g / 2 - e / 2 + 10,
      j = h / 2 - f / 2 + 50,
      k = b.open(a, d, "scrollbars=yes, width=" + e + ", height=" + f + ", top=" + j + ", left=" + i);
    k.focus()
  }
  ...
  a.extend(d.prototype, {
    init: function() {
      var c = this; - 1 == a.inArray(this.settings.place, l) && (this.settings.place = this._defaults.place);
      var d = a("<div>", {
  ...
  var k = {
      ...
      envelope: {
        className: "envelope",
        url: "mailto:asd@asd.com?subject={url}"
      },
      pinterest: {
        className: "pinterest",
        url: "https://pinterest.com/pin/create%2Fbutton/?url={url}"
      },
      stumbleupon: {
...
function(a) {
    ...
    a[c] = function(a, b, c) {
      ...
      _initPanels: function(b) {
        ...
        h.each(function() {
          var b = a(this),
            d = b.parent(),
            g = d.children("a, span").first();
          if (d.is("." + e.menu) || (d.data(f.sub, b), b.data(f.parent, d)), !d.children("." + e.next).length && d.parent().is("." + e.listview)) {
            var h = b.attr("id"),
              i = a('<a class="' + e.next + '" href="#' + h + '" data-target="#' + h + '" />').insertBefore(g);
            g.is("span") && i.addClass(e.fullsubopen)
          }
          if (!b.children("." + e.navbar).length && !d.hasClass(e.vertical)) {
            if (d.parent().is("." + e.listview)) var d = d.closest("." + e.panel);
            else var g = d.closest("." + e.panel).find('a[href="#' + b.attr("id") + '"]').first(),
              d = g.closest("." + e.panel);
      ...
      _initAnchors: function() {
        ...
        h.$body.on(g.click + "-oncanvas", "a[href]", function(d) {
          ...
          for (var j in a[c].addons)
            if (g = a[c].addons[j].clickAnchor.call(b, f, i)) break;
          if (!g && i) {
            var k = f.attr("href");
  ...
  a[b].addons[c] = {
    setup: function() {
      if (this.opts.offCanvas) {
        ...
        var e = this,
          h = this.opts[c];
        if (this.conf[c], g = a[b].glbl, "boolean" == typeof h && h && (h = {
            height: "auto"
          }), "object" != typeof h && (h = {}), h = this.opts[c] = a.extend(!0, {}, a[b].defaults[c], h), "auto" == h.height) {
  ...
  a[c].addons[d] = {
    setup: function() {
      if (this.opts.offCanvas) {
        var f = this,
          g = this.opts[d],
          i = this.conf[d];
        if (h = a[c].glbl, "boolean" == typeof g && (g = {
            open: g
          }), "object" != typeof g && (g = {}), g = this.opts[d] = a.extend(!0, {}, a[c].defaults[d], g), g.open) {
          var j, k, l, m, n, o = {},
            p = 0,
            q = !1,
            r = !1,
    ...
    add: function() {
      return "function" != typeof Hammer || Hammer.VERSION < 2 ? void(a[c].addons[d].setup = function() {}) : (e = a[c]._c, f = a[c]._d, g = a[c]._e, void e.add("dragging"))
    },
    clickAnchor: function() {}
  }, a[c].defaults[d] = {
    open: !1,
...
function(a) {
  ...
  a[b].addons[c][d] = function(c, d, e) {
    ...
    var h = function() {
      var a = this.$menu.children("." + f.current),
        b = c.find("." + f.breadcrumbs),
        d = a.children("." + f.navbar).children("." + f.breadcrumbs);
      b.html(d.html())
    };
...
function(a) {
  ...
  a[b].addons[c][d] = function(d) {
    ...
    var f = function(a) {
      ...
      var b = d.find("." + e.next),
        f = a.find("." + this.conf.classNames[c].panelNext),
        g = f.attr("href"),
        h = f.html();
...
function(a) {
  ...
  a[b].addons[c][d] = function(d) {
    ...
    var f = function() {
      var a = this.$menu.children("." + e.current),
        b = d.find("." + e.prev),
        f = a.find("." + this.conf.classNames[c].panelPrev);
...
function(a) {
  ...
  a[b].addons[c][d] = function(c) {
    var d = a[b]._c,
      e = a('<div class="' + d.search + '" />').appendTo(c);
...
function(a) {
  ...
  a[b].addons[c][d] = function(d, e) {
    ...
    var g = function(a) {
      ...
      var b = d.find("." + f.title),
        g = a.find("." + this.conf.classNames[c].panelTitle);
  ...
  a[c].addons[d] = {
    setup: function() {
      ...
      h = a[c].glbl, "boolean" == typeof j && (j = {
        add: j
      }), "object" != typeof j && (j = {}), j = this.opts[d] = a.extend(!0, {}, a[c].defaults[d], j), this.bind("close", function() {
          ...
          d.each(function() {
            ...
            if (!b.is("." + e.panel) || !b.is("." + e.vertical)) {
              if (!b.children("." + e.search).length) {
                var c = k.form ? "form" : "div",
                  d = a("<" + c + ' class="' + e.search + '" />');
                if (k.form && "object" == typeof k.form)
                  for (var f in k.form) d.attr(f, k.form[f]);
            ...
            var c = a(this),
              d = c.closest("." + e.panel).length;
            if (d) var h = c.closest("." + e.panel),
              k = h;
            else var h = a("." + e.panel, i.$menu),
              k = i.$menu;
            var l = c.children("input"),
              m = i.__findAddBack(h, "." + e.listview).children("li"),
              n = m.filter("." + e.divider),
              o = i.__filterListItems(m),
              p = "> a",
              q = p + ", > span",
              r = function() {
      ...
      this.conf[c], g = a[b].glbl, "boolean" == typeof h && (h = {
        ...
        if (!this.$indexer && this.$menu.children("." + d.hasindexer).length) {
          this.$indexer = a('<div class="' + d.indexer + '" />').prependTo(this.$menu).append('<a href="#a">a</a><a href="#b">b</a><a href="#c">c</a><a href="#d">d</a><a href="#e">e</a><a href="#f">f</a><a href="#g">g</a><a href="#h">h</a><a href="#i">i</a><a href="#j">j</a><a href="#k">k</a><a href="#l">l</a><a href="#m">m</a><a href="#n">n</a><a href="#o">o</a><a href="#p">p</a><a href="#q">q</a><a href="#r">r</a><a href="#s">s</a><a href="#t">t</a><a href="#u">u</a><a href="#v">v</a><a href="#w">w</a><a href="#x">x</a><a href="#y">y</a><a href="#z">z</a>'), this.$indexer.children().on(f.mouseover + "-sectionindexer " + d.touchstart + "-sectionindexer", function() {
            var b = a(this).attr("href").slice(1),
              c = e.$menu.children("." + d.current),
              f = c.find("." + d.listview),
              g = !1,
              h = c.scrollTop(),
              i = f.position().top + parseInt(f.css("margin-top"), 10) + parseInt(f.css("padding-top"), 10) + h;
  ...
  function(a) {
    ...
    var header_menu_home = (document).getElementById("header-menu-top-home");
    var header_menu = document.getElementById("header-menu-top");
    var header_menu_post = (document).getElementById("header-menu-top-post");
    var e = true;
    var search_form = $(".search-form");
    var header_input = $(".header-input");
    var logo = (document).getElementById("logo");
    var search_icon = (document).getElementById("ic-search");
    var close_icon = (document).getElementById("ic-search-close");
    var search_open = (document).getElementById("ic-search-open");
    var main = document.getElementById("main");
    var mobile_navi_button = document.getElementById("mobile-navi-button");
    var mobile_navi_button_icon = document.getElementById("ic-mobile-navi-button");
    var mobile = false;
    var is_home = (document.getElementById("layout-params").value === 'true');
    var phone_menu_bg = document.getElementById("phone-menu");
    var phone_search_area = document.getElementsByClassName("phone-header-input")[0];
    var ic_phone_search = document.getElementById("phone-ic-search");
    var ic_search_delete = document.getElementById("phone-ic-search-delete");
    
    var search_box_open_button = document.getElementById("id-search-box-open-button");
    var search_box = document.getElementById("id-search-box");
    var category_box = document.getElementById("header-submenu");
    var media_query = window.matchMedia( "(max-width: 860px)" );
    var media_query_mobile = window.matchMedia( "(max-width: 600px)" );

    var recruit_button = document.getElementById("recruit-button");
    var recruit_button_arrow = document.getElementById("recruit-button-arrow");
    
    var prev = document.getElementById("prev");
    var next = document.getElementById("next");
    var prev_img = document.getElementById("img-prev");
    var next_img = document.getElementById("img-next");

    var post_prev_text = document.getElementById("post-prev-text");
    var post_next_text = document.getElementById("post-next-text");

    var is_post = (document.getElementById("layout-params-post").value === 'true');

    var is_search_box_open = false;
    var navi_category_text = document.getElementById("navi-category-text");

    var is_search_box_hover = false; 

    navi_category_text.onmouseenter = function() {
      if (is_home) {
        if (e) {
          navi_category_text.style.color = "#ffffff";
          navi_category_text.style.opacity = "1";
        } else {
          navi_category_text.style.color = "#222222";
        }
      } else {
        navi_category_text.style.color = "#222222";
      }
      is_search_box_hover = true;
    }

    navi_category_text.onmouseleave = function() {
      if (is_home) {
        if (e) {
          navi_category_text.style.color = "#ffffff";
          navi_category_text.style.opacity = "0.8";
        } else {
          navi_category_text.style.color = "#666666";
        }
      } else {
        navi_category_text.style.color = "#666666";
      }
      is_search_box_hover = false; 
    }

    if (!media_query.matches) {
      if (recruit_button != null) {
        recruit_button.onmouseleave = function() {
          recruit_button_arrow.style.transform = "translateX(0px)";
          recruit_button.style.opacity = "1";
        }
        recruit_button.onmouseenter = function() {
          recruit_button_arrow.style.transform = "translateX(4px)";
          recruit_button.style.opacity = "0.9";
        }
      }
      if (is_post) {
        if (prev != null) {
          prev.onmouseenter = function() {
            prev_img.src = "/assets/images/resource/ic-backword-arrow-hover.png";
            prev_img.style.width = "5px";
            prev_img.style.height = "9px";
          }
          prev.onmouseleave = function() {
            prev_img.src = "/assets/images/resource/ic-backword-arrow.svg";
            prev_img.style.width = "5px";
            prev_img.style.height = "9px";
          }
        }
        if (next != null) {
          next.onmouseenter = function() {
            next_img.src = "/assets/images/resource/ic-foreword-arrow-hover.png";
            next_img.style.width = "5px";
            next_img.style.height = "9px";
          }
          next.onmouseleave = function() {
            next_img.src = "/assets/images/resource/ic-foreword-arrow.svg";
            next_img.style.width = "5px";
            next_img.style.height = "9px";
          }
        }
      ...
      if (is_post) {
        if (post_prev_text != null) {
          post_prev_text.innerHTML = "이전 글";
        }
        if (post_next_text != null) {
          post_next_text.innerHTML = "다음 글";
        }
      }
    }

    phone_search_area.onfocus = function() {
      ic_phone_search.src = "/assets/images/resource/ic-search-scroll-hover.png"
    }
    phone_search_area.onblur = function() {
      ic_phone_search.src = "/assets/images/resource/ic-search-scroll.png"
    }
    
    search_box_open_button.onmouseenter = function() {
      if(is_home) {
        if (e) {
          search_open.src = "/assets/images/resource/ic-search-default-hover.png";
        } else {
          search_open.src = "/assets/images/resource/ic-search-scroll-hover.png";
        }
      } else {
        search_open.src = "/assets/images/resource/ic-search-scroll-hover.png";
      }
    ...
    search_box_open_button.onmouseleave = function() {
      if(is_home) {
        if (e) {
          search_open.src = "/assets/images/resource/ic-search-default.png";
        } else {
          search_open.src = "/assets/images/resource/ic-search-scroll.png";
        }
      } else {
        search_open.src = "/assets/images/resource/ic-search-scroll.png";
      }
    ...
    search_box_open_button.onclick = function() {
      search_box.style.display = "block";
      search_box_open_button.style.display = "none";
      if (is_home) {
        if (e) {
          search_icon.src = "/assets/images/resource/ic-search-open-box.png"
        } else {
          search_icon.src = "/assets/images/resource/ic-search-open-box-scroll.png"
        }
      } else {
        search_icon.src = "/assets/images/resource/ic-search-open-box-scroll.png"
      }
      if (media_query.matches) {
        category_box.style.transform = "translateX(0%)";
      }
      else {
        category_box.style.transform = "translateX(-35%)";
      }
      is_search_box_open = true;
    }

    close_icon.onclick = function() {
      search_box.style.display = "none";
      search_box_open_button.style.display = "block";
      if (is_home) {
        if (e) {
          search_icon.src = "/assets/images/resource/ic-search-default.png"
        } else {
          search_icon.src = "/assets/images/resource/ic-search-scroll.png"
        }
      } else {
        search_icon.src = "/assets/images/resource/ic-search-scroll.png"
      }
      category_box.style.transform = "translateX(-50%)";
      is_search_box_open = false;
      return false;
    };

    phone_search_area.oninput = function() {
      if (phone_search_area.value.length > 0) {
        ic_search_delete.style.display = "block";
      } else {
        ic_search_delete.style.display = "none";
      }
    }
    
    mobile_navi_button.onclick = function phone_mode() {
      if(is_home) {
        if (mobile) {
          mobile_navi_button_icon.src = "/assets/images/resource/btn-mobile-menu-open.png";
          phone_menu_bg.style.display = "none"
          if (header_menu_home != null) {
            header_menu_home.className = "header-menu header-menu-top";
          }
          search_form.attr("class", "search-form");
          header_input.attr("class", "header-input");
          logo.src = "/assets/images/resource/logo-default.png";
          search_icon.src = "/assets/images/resource/ic-search-default.png";
          close_icon.src = "/assets/images/resource/ic-search-close.png";
          search_open.src = "/assets/images/resource/ic-search-default.png";
          main.style.display = "block";
          mobile = false;
          document.body.style.background = "#f7f8fa";
        } else {
            mobile_navi_button_icon.src = "/assets/images/resource/btn-mobile-close.png";
            phone_menu_bg.style.display = "block";
            if (header_menu_home != null) {
              header_menu_home.className = "header-menu header-menu-overflow";
            }
            search_form.attr("class", "search-form-overflow");
            header_input.attr("class", "header-input-overflow");
            logo.src = "/assets/images/resource/logo-scroll.png";
            search_icon.src = "/assets/images/resource/ic-search-scroll.png";
            close_icon.src = "/assets/images/resource/ic-search-close-overflow.png";
            search_open.src = "/assets/images/resource/ic-search-scroll.png";
          ...
          if (mobile) {
            mobile_navi_button_icon.src = "/assets/images/resource/btn-mobile-menu-open-overflow.png";
            phone_menu_bg.style.display = "none"
            if (header_menu_home != null) {
              header_menu_home.className = "header-menu header-menu-top";
            }
    ...
    $(window).scroll(function() {
      if (header_menu_home != null) {
        ...
        if (b > 3) {
          if (e && !mobile) {
            ...
            mobile_navi_button_icon.src = "/assets/images/resource/btn-mobile-menu-open-overflow.png";
            search_open.src = "/assets/images/resource/ic-search-scroll.png";
            if (is_search_box_open) {
              search_icon.src = "/assets/images/resource/ic-search-open-box-scroll.png"
            } else {
              search_icon.src = "/assets/images/resource/ic-search-scroll.png";
            }
            if (is_home) {
              if (is_search_box_hover) {
                navi_category_text.style.color = "#222222";
              } else {
                navi_category_text.style.color = "#666666";
              }
          ...
          if (!e && !mobile) {
            ...
            search_form.attr("class", "search-form");
            if (is_home) {
              console.log("is_home_not scroll");
              header_input.attr("class", "header-input");
            }
            logo.src = "/assets/images/resource/logo-default.png";
            search_icon.src = "/assets/images/resource/ic-search-default.png";
      ...
      } else if (header_menu_post != null) {
        var b = $(window).scrollTop();
        if (b > 3) {
          if (e && is_post) {
            header_menu_post.classList.remove("archive-layout");
          }
          e = false;
        } else {
          if(!e && is_post) {
            header_menu_post.classList.add("archive-layout");
          }
          e = true;
        }
      }
