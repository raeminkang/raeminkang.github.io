...
function(a) {
  ...
  function(a) {
    ...
    $(window).scroll(function() {
      ...
      } else if (header_menu != null) {
        var b = $(window).scrollTop();
        if (b > 3) {
          if (e && is_home) {
            console.log("boxShadow on");
            header_menu.classList.remove("archive-layout");
          }
          e = false;
        } else {
          if(!e && is_home) {
            console.log("boxShadow off");
            header_menu.classList.add("archive-layout");
          }
          e = true;
        }
      }
