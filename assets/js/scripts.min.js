...
function(a) {
  ...
  function(a) {
    ...
    mobile_navi_button.onclick = function phone_mode() {
      if(is_home) {
        if (mobile) {
          ...
          if (header_menu != null) {
            header_menu.className = "header-menu header-menu-top";
          }
          search_form.attr("class", "search-form");
          header_input.attr("class", "header-input");
          logo.src = baseurl + "/assets/images/resource/logo-default.png";
          search_icon.src = baseurl + "/assets/images/resource/ic-search-default.png";
          close_icon.src = baseurl + "/assets/images/resource/ic-search-close.png";
          search_open.src = baseurl + "/assets/images/resource/ic-search-default.png";
          ...
          document.body.style.background = "#f7f8fa";
            ...
            if (header_menu != null) {
              header_menu.className = "header-menu header-menu-overflow";
            }
            search_form.attr("class", "search-form-overflow");
            header_input.attr("class", "header-input-overflow");
            logo.src = baseurl + "/assets/images/resource/logo-scroll.png";
            search_icon.src = baseurl + "/assets/images/resource/ic-search-scroll.png";
            close_icon.src = baseurl + "/assets/images/resource/ic-search-close-overflow.png";
            search_open.src = baseurl + "/assets/images/resource/ic-search-scroll.png";
    ...
    // TODO change baseurl !
    var baseurl = "http://https://raeminkang.github.io"
